...
public class menuDB {
	public static List<MenuList> adminMenu() {
		...
		List<MenuList> childrenList3 = new ArrayList<MenuList>();
		childrenList3.add(new MenuList("所有用户", "/maintainRole", "home", "false", null));
		...
		list.add(new MenuList("用户管理", "/role", "home", "true", childrenList3));
		return list;
	}
